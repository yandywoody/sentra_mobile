...
import 'package:sentra_mobile/modules/engineering/controller/wo_repair_controller.dart';
import 'package:sentra_mobile/routes/app_routes.dart';

class WoRepair extends GetView<WoRepairController> {
  WoRepair({Key? key}) : super(key: key);
  final controller = Get.put(WoRepairController());
