...
import 'package:sentra_mobile/modules/engineering/controller/wo_repair_detail_controller.dart';
...
class WoRepairDetail extends GetView<WoRepairDetailController> {
  WoRepairDetail({Key? key}) : super(key: key);
  final controller = Get.put(WoRepairDetailController());
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        GetBuilder<WoRepairDetailController>(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Column(
                                                        children: [
                                                          Text(
                                                              "${controller.dtGoodRequest.length + controller.dtGoodRequestItem.length}",
                                                              style:
                                                                  const TextStyle(
                                                                color: Colors
                                                                    .white,
                                                                      ...
                                                                      Expanded(
                                                                        child: ListView
                                                                          ...
                                                                          itemBuilder: (BuildContext context, int index) =>
                                                                              GestureDetector(
                                                                            onTap: () =>
                                                                                _viewFullImage(controller.imgContent[index], context),
                                                                            child:
                                                                                Card(
                                                                              child: Center(
                                                                                child: Image.file(
                                                                                  File(controller.imgContent.value[index].path!),
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          ),
