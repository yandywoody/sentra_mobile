...
class WoServiceDetail extends GetView<WoServiceDetailController> {
  WoServiceDetail({Key? key}) : super(key: key);
  final controller = Get.put(WoServiceDetailController());
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        GetBuilder<WoServiceDetailController>(
  ...
  void _choiceAction(String choice, BuildContext context) async {
    if (choice == "handover") {
      controller.data.workType = "Service";
