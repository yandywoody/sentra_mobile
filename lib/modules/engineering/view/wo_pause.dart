...
import 'package:sentra_mobile/modules/engineering/controller/wo_pause_controller.dart';
...
class WoPause extends GetView<WoPauseController> {
  WoPause({Key? key}) : super(key: key);
  final controller = Get.put(WoPauseController());
                    ...
                    Obx(
                      () => Container(
                        ...
                        child: ListView.builder(
                          scrollDirection: Axis.vertical,
                          shrinkWrap: true,
                          itemCount: controller.dtWoAllFilter.length,
                          itemBuilder: (BuildContext context, int i) {
                            return Padding(
                              padding:
                                  const EdgeInsets.only(left: 10, right: 10),
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Container(
                                                    width: Get.width * 0.5,
                                                    child: Text(
                                                        "${controller.dtWoAllFilter[i].activityCode}",
                                                        style: AppTheme.title),
                                                  ),
                                                ],
                                              ),
